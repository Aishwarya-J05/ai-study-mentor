...
// // Global SpeechRecognition types (safe & typed)
// declare global {
//   interface Window {
...
//                   ))}
//                 </div>
//                 <p className="sidebar-tip">Tip: Paste any text and ask me to explain it!</p>
//               </div>
//             </motion.aside>
//           )}
//         </AnimatePresence>
...
//               </button>
//             </div>
//             <p className="footer-note">Powered by Gemini • Voice input • Shift+Enter for new line</p>
//           </footer>
//         </main>
//       </div>
...
//         @keyframes pulse {
//           0% { box-shadow: 0 0 0 0 0 rgba(239, 68, 68, 0.7); }
